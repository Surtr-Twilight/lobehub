...
import MobileMainLayout from '@/routes/(mobile)/_layout';
import MobileHome from '@/routes/(mobile)/(home)/';
import MobileHomeLayout from '@/routes/(mobile)/(home)/_layout';
import MobileChatLayout from '@/routes/(mobile)/chat/_layout';
import MobileMeHomeLayout from '@/routes/(mobile)/me/(home)/layout';
import MobileMeProfileLayout from '@/routes/(mobile)/me/profile/layout';
import MobileMeSettingsLayout from '@/routes/(mobile)/me/settings/layout';
import MobileSettingsProviderLayout from '@/routes/(mobile)/settings/provider/_layout';
import {
